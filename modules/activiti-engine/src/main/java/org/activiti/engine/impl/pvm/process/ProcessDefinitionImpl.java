...
public class ProcessDefinitionImpl extends ScopeImpl implements PvmProcessDefinition {
    ...
    private static final Logger                     LOGGER                = LoggerFactory
                                                                              .getLogger(ProcessDefinitionImpl.class);
    ...
    // In our case the initial will always be StartEvent
    public PvmProcessInstance createProcessInstance() {
        ...
        LOGGER.info("ready to create PvmProcessInstance with initial {}", initial.getId());
