...
public class DeployCmd<T> implements Command<Deployment>, Serializable {
    ...
    public Deployment execute(CommandContext commandContext) {
        ...
        deployment.setDeploymentTime(commandContext.getProcessEngineConfiguration().getClock()
            .getCurrentTime());

        // By default isDuplicateFilterEnabled returns false
        ...
        // Save the data, this will insert into both deployment&resource tables
        ...
        // Actually deploy
        // TODO: need to figure out time usage
