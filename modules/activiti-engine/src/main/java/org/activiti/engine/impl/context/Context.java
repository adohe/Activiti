    ...
    public static ObjectNode getLocalizationElementProperties(String language, String id,
        ...
        if (definitionInfoNode != null) {
            if (useFallback == false) {
                ...
                candidateLocales.addAll(resourceBundleControl.getCandidateLocales(id, new Locale(
                    language)));
                candidateLocales.addAll(resourceBundleControl.getCandidateLocales(id,
                    Locale.getDefault()));
                for (Locale locale : candidateLocales) {
                    localizationProperties = getProcessEngineConfiguration()
                        .getDynamicBpmnService().getLocalizationElementProperties(
    ...
    protected static ObjectNode getProcessDefinitionInfoNode(String processDefinitionId) {
        ...
        if (bpmnOverrideMap.containsKey(processDefinitionId) == false) {
            ProcessDefinitionInfoCacheObject cacheObject = getProcessEngineConfiguration()
                .getDeploymentManager().getProcessDefinitionInfoCache().get(processDefinitionId);
