...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {
    ...
    */
    ...
    // Generally Command Interceptors include: LogInterceptor, TransactionInterceptor, CommandContextInterceptor
    // CommandInvoker, and this will be executed one by one.
    ...
    protected Collection<? extends CommandInterceptor> getDefaultCommandInterceptors() {
        ...
        // This will return SpringTransactionInterceptor
        ...
        if (dataSource == null) {
            if (dataSourceJndiName != null) {
                try {
                    ...
                    throw new ActivitiException("couldn't lookup datasource from "
                                                + dataSourceJndiName + ": " + e.getMessage(), e);
                }
            ...
            try {
                ...
                if (databaseType != null) {
                    ...
                    properties.put("limitOuterJoinBetween",
                        DbSqlSessionFactory.databaseOuterJoinLimitBetweenStatements
                            .get(databaseType));
                ...
                throw new ActivitiException("Error while building ibatis SqlSessionFactory: "
                                            + e.getMessage(), e);
            } finally {
    ...
    protected Configuration parseMybatisConfiguration(Configuration configuration,
    ...
    protected void initConfigurators() {
        ...
        if (enableConfiguratorServiceLoader) {
            ...
            ServiceLoader<ProcessEngineConfigurator> configuratorServiceLoader = ServiceLoader
                .load(ProcessEngineConfigurator.class, classLoader);
            ...
            for (int i = 0; i < bpmnParserHandlers.size(); i++) {
                ...
                if (defaultBpmnParseHandler.getHandledTypes().size() != 1) {
                    ...
                    if (customParseHandlerMap.containsKey(handledType)) {
                        BpmnParseHandler newBpmnParseHandler = customParseHandlerMap
                            .get(handledType);
        ...
        if (isAsyncExecutorEnabled()) {
            if (asyncExecutor == null) {
                ...
                defaultAsyncExecutor
                    .setDefaultTimerJobAcquireWaitTimeInMillis(asyncExecutorDefaultTimerJobAcquireWaitTime);
                defaultAsyncExecutor
                    .setDefaultAsyncJobAcquireWaitTimeInMillis(asyncExecutorDefaultAsyncJobAcquireWaitTime);

                // Queue full wait time
                defaultAsyncExecutor
                    .setDefaultQueueSizeFullWaitTimeInMillis(asyncExecutorDefaultQueueSizeFullWaitTime);

                // Job locking
                defaultAsyncExecutor.setTimerLockTimeInMillis(asyncExecutorTimerLockTimeInMillis);
                defaultAsyncExecutor
                    .setAsyncJobLockTimeInMillis(asyncExecutorAsyncJobLockTimeInMillis);
                ...
                // Retry
                defaultAsyncExecutor
                    .setRetryWaitTimeInMillis(asyncExecutorLockRetryWaitTimeInMillis);

                // Shutdown
                defaultAsyncExecutor
                    .setSecondsToWaitOnShutdown(asyncExecutorSecondsToWaitOnShutdown);
    ...
    protected void initEventDispatcher() {
        ...
        if (typedEventListeners != null) {
            for (Entry<String, List<ActivitiEventListener>> listenersToAdd : typedEventListeners
                .entrySet()) {
                // Extract types from the given string
                ActivitiEventType[] types = ActivitiEventType.getTypesFromString(listenersToAdd
                    .getKey());
