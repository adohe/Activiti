 ...
 * @author Joram Barrez
 */
public class SubProcessActivityBehavior extends AbstractBpmnActivityBehavior implements
    ...
    public void lastExecutionEnded(ActivityExecution execution) {
        ...
        Map<String, Object> dataObjectVars = ((ActivityImpl) execution.getActivity())
            .getVariables();
