...
public class DeploymentBuilderImpl implements DeploymentBuilder, Serializable {
    ...
    public DeploymentBuilder addInputStream(String resourceName, InputStream inputStream) {
        if (inputStream == null) {
            throw new ActivitiIllegalArgumentException("inputStream for resource '" + resourceName
                                                       + "' is null");
        }
    ...
    // We will pass XML string directly
    ...
    public DeploymentBuilder addBpmnModel(String resourceName, BpmnModel bpmnModel) {
        ...
        try {
            ...
            throw new ActivitiException(
                "Errot while transforming BPMN model to xml: not UTF-8 encoded", e);
        }
        return this;
    }
