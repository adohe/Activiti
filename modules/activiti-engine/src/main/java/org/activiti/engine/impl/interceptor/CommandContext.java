...
/**
 * CommandContext is always ThreadLocal variable.
 * 
 * @author Tom Baeyens
 * @author Agim Emruli
 * @author Joram Barrez
...
public class CommandContext {
    ...
    public CommandContext(Command<?> command,
        ...
        this.transactionContext = processEngineConfiguration.getTransactionContextFactory()
    ...
    public <T> T getSession(Class<T> sessionClass) {
        ...
        if (session == null) {
            ...
            if (sessionFactory == null) {
                throw new ActivitiException("no session factory configured for "
