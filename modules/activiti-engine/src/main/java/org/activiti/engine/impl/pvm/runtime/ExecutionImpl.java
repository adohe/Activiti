 ...
 * @author Falko Menge
 */
public class ExecutionImpl implements Serializable, ActivityExecution, ExecutionListenerExecution,
                          PvmExecution, InterpretableExecution {
            ...
            for (ActivityExecution concurrentExecution : concurrentExecutions) {
                if (concurrentExecution.getActivity() != null
                    ...
                    if (concurrentExecution.isActive()) {
                        throw new PvmException("didn't expect active execution in " + activity
                                               + ". bug?");
                    }
        ...
        if ((transitions.size() == 1) && (concurrentActiveExecutions.isEmpty())) {
            ...
            while (!transitions.isEmpty()) {
                ...
                if (recyclableExecutions.isEmpty()) {
                    ...
                    log.debug("new {} created to take transition {}", outgoingExecution,
                        outgoingTransition);
                } else {
