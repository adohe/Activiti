 ...
 */
public class ExecutionEntity extends VariableScopeImpl implements ActivityExecution,
                                                      ExecutionListenerExecution, Execution,
                                                      PvmExecution, ProcessInstance,
                                                      InterpretableExecution, PersistentObject,
                                                      HasRevision {

    private static final long               serialVersionUID              = 1L;

    private static Logger                   log                           = LoggerFactory
                                                                              .getLogger(ExecutionEntity.class);
    ...
    protected int                           suspensionState               = SuspensionState.ACTIVE
                                                                              .getStateCode();
    ...
    public PvmProcessInstance createSubProcessInstance(PvmProcessDefinition processDefinition) {
        ...
        Map<String, Object> dataObjectVars = ((ProcessDefinitionEntity) processDefinition)
            .getVariables();
        ...
        if (eventSubscriptionDeclarations != null) {
            for (EventSubscriptionDeclaration eventSubscriptionDeclaration : eventSubscriptionDeclarations) {
                if (!eventSubscriptionDeclaration.isStartEvent()) {
                    EventSubscriptionEntity eventSubscriptionEntity = eventSubscriptionDeclaration
                        .prepareEventSubscriptionEntity(this);
                    if (getTenantId() != null) {
                ...
                Context
                    ...
                    .dispatchEvent(
                        ActivitiEventBuilder.createSignalEvent(ActivitiEventType.ACTIVITY_SIGNALED,
                            signalledActivityId, signalName, signalData, this.id,
    ...
    public List<ActivityExecution> findInactiveConcurrentExecutions(PvmActivity activity) {
        ...
        if (log.isDebugEnabled()) {
            log.debug("inactive concurrent executions in '{}': {}", activity,
        ...
        if ((transitions.size() == 1) && (concurrentActiveExecutions.isEmpty())
            ...
            while (!transitions.isEmpty()) {
                ...
                if (recyclableExecutions.isEmpty()) {
                    ...
                    log.debug("recycled {} to take transition {}", outgoingExecution,
                        outgoingTransition);
                }
            ...
            Context
                ...
                .dispatchEvent(
                    ActivitiEventBuilder.createActivityEvent(ActivitiEventType.ACTIVITY_COMPLETED,
                        ...
                        getActivity() != null ? (String) getActivity().getProperties().get("name")
                            : null, getId(), getProcessInstanceId(), getProcessDefinitionId(),
                        getActivity() != null ? (String) getActivity().getProperties().get("type")
                            : null, getActivity() != null ? getActivity().getActivityBehavior()
            ...
            for (ExecutionEntity execution : executions) {
                ...
                if (!execution.isEnded) {
                    if ((activityId == null && otherActivityId != null)
                        ...
                        || (activityId != null && otherActivityId != null && !otherActivityId
                            .equals(activityId))) {
                        return false;
                    }
                }
    ...
    protected void scheduleAtomicOperationAsync(AtomicOperation executionOperation) {
        ...
        ProcessEngineConfiguration processEngineConfig = Context.getCommandContext()
            .getProcessEngineConfiguration();
    ...
    protected void ensureParentInitialized() {
        if (parent == null && parentId != null) {
            parent = Context.getCommandContext().getExecutionEntityManager()
    ...
    protected void ensureSuperExecutionInitialized() {
        if (superExecution == null && superExecutionId != null) {
            superExecution = Context.getCommandContext().getExecutionEntityManager()
    ...
    protected void ensureSubProcessInstanceInitialized() {
        if (subProcessInstance == null) {
            subProcessInstance = Context.getCommandContext().getExecutionEntityManager()
    ...
    public void setReplacedBy(InterpretableExecution replacedBy) {
        ...
        for (TaskEntity task : allTasks) {
            ...
            List<VariableInstanceEntity> variables = (List) commandContext
                .getVariableInstanceEntityManager().findVariableInstancesByTaskId(task.getId());
        ...
        List<VariableInstanceEntity> variables = (List) commandContext
            .getVariableInstanceEntityManager().findVariableInstancesByExecutionId(id);
    ...
    protected void updateVariableInstance(VariableInstanceEntity variableInstance, Object value,
        ...
        if (Context.getProcessEngineConfiguration() != null
            ...
            Context
                ...
                .getEventDispatcher()
                .dispatchEvent(
                    ActivitiEventBuilder.createVariableEvent(ActivitiEventType.VARIABLE_UPDATED,
                        variableInstance.getName(), value, variableInstance.getType(),
    ...
    protected void ensureJobsInitialized() {
        if (jobs == null) {
            jobs = (List) Context.getCommandContext().getJobEntityManager()
    ...
    protected void ensureTasksInitialized() {
        if (tasks == null) {
            tasks = (List) Context.getCommandContext().getTaskEntityManager()
    ...
    public void deleteIdentityLink(String userId, String groupId, String type) {
        List<IdentityLinkEntity> identityLinks = Context.getCommandContext()
